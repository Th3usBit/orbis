...
export const UI = {
  en: {
    ...
    sources: 'Sources',
    filters: 'Filters',
    skip_to_events: 'Skip to the event list',
    ...
    export_ics: 'ics',
    export_csv: 'csv',
    aria_export_ics: 'Download these events as a calendar file',
    aria_export_csv: 'Download these events as a spreadsheet',
    ics_calname: 'orbis — economic calendar',
    csv_date: 'Date',
    csv_time: 'Time (UTC)',
    csv_country: 'Country',
    csv_event: 'Event',
    csv_surprise: 'Surprise',
    csv_unit: 'Unit',
    csv_source: 'Released by',
    today: 'today',
    hint: 'Drag to rotate · scroll to zoom · click a marker · ← → change day',
    ...
    days_short: 'd',
    stale: 'This calendar has not been rebuilt for {n}. The figures may have moved.',
  ...
  pt: {
    ...
    sources: 'Fontes',
    filters: 'Filtros',
    skip_to_events: 'Ir para a lista de eventos',
    ...
    export_ics: 'ics',
    export_csv: 'csv',
    aria_export_ics: 'Baixar estes eventos como arquivo de calendário',
    aria_export_csv: 'Baixar estes eventos como planilha',
    ics_calname: 'orbis — calendário econômico',
    csv_date: 'Data',
    csv_time: 'Hora (UTC)',
    csv_country: 'País',
    csv_event: 'Evento',
    csv_surprise: 'Surpresa',
    csv_unit: 'Unidade',
    csv_source: 'Divulgado por',
    today: 'hoje',
    hint: 'Arraste para girar · role para aproximar · clique num marcador · ← → muda o dia',
    ...
    days_short: 'd',
    stale: 'Este calendário não é reconstruído há {n}. Os números podem ter mudado.',
  ...
  es: {
    ...
    sources: 'Fuentes',
    filters: 'Filtros',
    skip_to_events: 'Ir a la lista de eventos',
    ...
    export_ics: 'ics',
    export_csv: 'csv',
    aria_export_ics: 'Descargar estos eventos como archivo de calendario',
    aria_export_csv: 'Descargar estos eventos como hoja de cálculo',
    ics_calname: 'orbis — calendario económico',
    csv_date: 'Fecha',
    csv_time: 'Hora (UTC)',
    csv_country: 'País',
    csv_event: 'Evento',
    csv_surprise: 'Sorpresa',
    csv_unit: 'Unidad',
    csv_source: 'Publicado por',
    today: 'hoy',
    hint: 'Arrastra para girar · rueda para acercar · haz clic en un marcador · ← → cambia el día',
    ...
    days_short: 'd',
    stale: 'Este calendario no se reconstruye desde hace {n}. Las cifras pueden haber cambiado.',
...
export const PHRASES = {
  pt: [
    ...
    ['Manufacturing Index', 'Índice industrial'],
    ['Business Conditions', 'Condições de negócios'],
    ['Business Barometer', 'Barômetro empresarial'],
    ['National Activity Index', 'Índice de atividade nacional'],
    ['Services Activity Index', 'Índice de atividade em serviços'],
    ['Housing Market Index', 'Índice do mercado imobiliário'],
    ['Current Conditions', 'Condições atuais'],
    ['Economic Activity', 'Atividade econômica'],
    ['Economic Projections', 'Projeções econômicas'],
    ['Economic Forecasts', 'Previsões econômicas'],
    ['Prices Paid', 'Preços pagos'],
    ['New Orders', 'Novos pedidos'],
    ['Employment', 'Emprego'],
    ['Policy Rate', 'Taxa de política monetária'],
    ['Federal Funds Rate', 'Taxa dos Fed Funds'],
    ['Official Bank Rate', 'Taxa oficial do banco central'],
    ['Overnight Borrowing Rate', 'Taxa de captação overnight'],
    ['Marginal Lending Rate', 'Taxa de empréstimo marginal'],
    ['Loan Prime Rate', 'Taxa preferencial de empréstimo'],
    ['Statement', 'Comunicado'],
    ['Meeting Summary', 'Resumo da reunião'],
    ['Summary of Deliberations', 'Resumo das deliberações'],
    ['Vote Cut', 'Votos por corte'],
    ['Vote Hike', 'Votos por alta'],
    ['Vote Unchanged', 'Votos por manutenção'],
    ['Meeting', 'Reunião'],
    ['New Loans', 'Novos empréstimos'],
    ['New Yuan Loans', 'Novos empréstimos em yuan'],
    ['Total Social Financing', 'Financiamento social total'],
    ['Central Government Debt', 'Dívida do governo central'],
    ['Monthly Budget Statement', 'Relatório mensal do orçamento'],
    ['Capital Flows', 'Fluxos de capital'],
    ['Foreign Securities Purchases', 'Compras de títulos estrangeiros'],
    ['Cash Remittances', 'Remessas'],
    ['Employed Persons', 'Pessoas empregadas'],
    ['Unemployment Claims', 'Pedidos de seguro-desemprego'],
    ['Construction Cost Index', 'Índice de custo da construção'],
    ['House Price Balance', 'Balanço de preços de imóveis'],
    ['Price Index', 'Índice de preços'],
    ['Natural Gas Storage', 'Estoques de gás natural'],
    ['Oil Market Report', 'Relatório do mercado de petróleo'],
    ['Report', 'Relatório'],
    ['Index', 'Índice'],
    ['GDP', 'PIB'],
    ['PMI', 'PMI'],
  ...
  es: [
    ...
    ['Manufacturing Index', 'Índice manufacturero'],
    ['Business Conditions', 'Condiciones empresariales'],
    ['Business Barometer', 'Barómetro empresarial'],
    ['National Activity Index', 'Índice de actividad nacional'],
    ['Services Activity Index', 'Índice de actividad de servicios'],
    ['Housing Market Index', 'Índice del mercado inmobiliario'],
    ['Current Conditions', 'Condiciones actuales'],
    ['Economic Activity', 'Actividad económica'],
    ['Economic Projections', 'Proyecciones económicas'],
    ['Economic Forecasts', 'Previsiones económicas'],
    ['Prices Paid', 'Precios pagados'],
    ['New Orders', 'Nuevos pedidos'],
    ['Employment', 'Empleo'],
    ['Policy Rate', 'Tasa de política monetaria'],
    ['Federal Funds Rate', 'Tasa de los fondos federales'],
    ['Official Bank Rate', 'Tasa oficial del banco central'],
    ['Overnight Borrowing Rate', 'Tasa de captación a un día'],
    ['Marginal Lending Rate', 'Tasa de préstamo marginal'],
    ['Loan Prime Rate', 'Tasa preferencial de préstamo'],
    ['Statement', 'Comunicado'],
    ['Meeting Summary', 'Resumen de la reunión'],
    ['Summary of Deliberations', 'Resumen de las deliberaciones'],
    ['Vote Cut', 'Votos por recorte'],
    ['Vote Hike', 'Votos por subida'],
    ['Vote Unchanged', 'Votos por mantener'],
    ['Meeting', 'Reunión'],
    ['New Loans', 'Nuevos préstamos'],
    ['New Yuan Loans', 'Nuevos préstamos en yuanes'],
    ['Total Social Financing', 'Financiación social total'],
    ['Central Government Debt', 'Deuda del gobierno central'],
    ['Monthly Budget Statement', 'Informe mensual del presupuesto'],
    ['Capital Flows', 'Flujos de capital'],
    ['Foreign Securities Purchases', 'Compras de valores extranjeros'],
    ['Cash Remittances', 'Remesas'],
    ['Employed Persons', 'Personas empleadas'],
    ['Unemployment Claims', 'Solicitudes de desempleo'],
    ['Construction Cost Index', 'Índice de costes de construcción'],
    ['House Price Balance', 'Balance de precios de vivienda'],
    ['Price Index', 'Índice de precios'],
    ['Natural Gas Storage', 'Almacenamiento de gas natural'],
    ['Oil Market Report', 'Informe del mercado petrolero'],
    ['Report', 'Informe'],
    ['Index', 'Índice'],
    ['GDP', 'PIB'],
    ['PMI', 'PMI'],
